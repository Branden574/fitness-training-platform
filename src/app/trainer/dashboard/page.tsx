        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-14">
            ...
            <div className="flex items-center gap-1.5 flex-shrink-0">
              ...
              <button onClick={() => setActiveTab('settings')} className="p-2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors rounded-lg" title="Settings">
              ...
              <button onClick={handleSignOut} className="sm:hidden p-2 text-gray-400 hover:text-red-500 transition-colors rounded-lg" title="Sign Out">
