...
const ContactForm = ({ className = '' }: ContactFormProps) => {
  ...
  return (
    ...
    >
      ...
      <p className="text-gray-600 mb-6">Fill out this form so Brent can understand your fitness goals and create a personalized training plan for you.</p>
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <textarea
            ...
            rows={3}
            className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all resize-none text-black"
            placeholder="Tell us more about your fitness journey, specific questions, or anything else you'd like Brent to know... (minimum 10 characters)"
          />
        </div>
        ...
        <motion.button
          ...
          className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold py-4 px-6 rounded-lg hover:from-blue-700 hover:to-purple-700 focus:ring-4 focus:ring-blue-300 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
